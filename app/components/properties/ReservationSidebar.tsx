...
const ReservationSidebar: React.FC<ReservationSidebarProps> = ({
    ...
    return ( 
        <aside className="mt-6 p-6 col-span-2 rounded-xl border border-gray-300 shdow-xl">
            ...
            <div 
                className="w-full mb-6 py-6 text-center text-white bg-red-400 hover:bg-red-600 rounded-xl"
